...
function resetQuiz() {
  ...
  const titlePageContent = '<div id="title-container"><h1>Welcome to Where in the World?</h1><input type="text" id="player-name-input" placeholder="Enter your name" /><button id="start-button">Start the quiz!</button></div>';
...
function showResult() {
    ...
    setTimeout(function(){
        document.getElementById("main-container").innerHTML = 
          ...
          '"><p>' + questions[currentQuestionNumber-1].description + 
